...
class TicTacToe:
    ...
    def available_moves(self):
        return [i for (i, spot) in enumerate(self.board) if spot == ' '] #this is an example of list comprehension
        # (or)
        # moves = []
        # for (i,spot) in enumerate(self.board):
        #     # enumerate does the following: ['x' , 'o' , 'o'] --> [(0, 'x'), (1, 'o'), (2, 'o')]
        #         if spot == ' ':
        #         moves.append(i)
        # return moves
    ...
    def winner(self, square, letter):
        # winner if 3 in a row anywher.. we have to check all of these!
